...
// Password requirement tooltip component 
...
const PasswordTooltip = ({ validationState }) => {
  const { hasMinLength, hasUppercase, hasLowercase, hasNumber, hasSpecial } = validationState;
...
const SignupForm = ({
  ...
  return (
    <>
      ...
      {showPasswordTooltip && <PasswordTooltip validationState={validationState} />}
