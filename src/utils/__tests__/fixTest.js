...
function verifyAccountSetupScreenImport() {
  try {
    ...
    const hasCorrectImport = content.includes("import { dataAPI } from '../utils/dataAPI.js.js.js.js.js'");
    const hasIncorrectImport = content.includes("import dataAPI from '../dataAPI.js.js.js.js.js'");
    
    console.log(`Current import statement is incorrect: \x1b[33m${hasIncorrectImport}\x1b[0m`);
    console.log(`The correct import should be: import { dataAPI } from '../utils/dataAPI.js.js.js.js.js'`);
