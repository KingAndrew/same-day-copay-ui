...
function App() {
  ...
  const renderScreen = () => {
    switch(currentScreen) {
      case 'login':
        return <LoginScreen navigateTo={setCurrentScreen} setUserData={setUserData} />;
      case 'main-menu':
        return <MainMenuScreen navigateTo={setCurrentScreen} userData={userData} />;
      case 'new-purchase':
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.boxFull}>
        ...
        <Text style={styles.usernameText}>{userData?.username || 'David Smith'}</Text>
